    ...
    <div className="relative inline-block text-left mb-5"> 
      ...
      <button
        ...
        className="inline-flex items-center justify-between w-full py-2.5 px-4 text-m font-medium text-gray-700
                   ...
                   focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" // Изменил цвет фокуса на indigo
      >
            ...
            return (
              <button
                ...
                className={`block w-full text-left px-4 py-2.5 text-m 
                            ...
                            hover:bg-indigo-100 hover:text-aqua focus:outline-none focus:bg-indigo-100 focus:text-indigo-700`}
                role="menuitem"
              >
                {sortLabels[value]}
              </button>
